...
namespace MitoR
{
  class EXP_IMP_DECL Configuracao
  {
  public:
    explicit Configuracao(const QString idConfigurador);
    Configuracao(const QString idConfigurador, const QFileInfo nomeArquivo);
