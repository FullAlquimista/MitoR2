...
A tabela auxiliar cadastro.planos_conta_ct é utilizada para armazenar as hierarquias entre os 'itens' cadastrados na tabela cadastro.planos_conta.  **Todo o sistema utiliza está abstração para criar uma hierarquia.**
...
```
### Material
Um material é um insumo direto utilizado na construção do equipamento que pode ser instalado sem modificação ou  recisar ser industrializado. Também pode ser uma ferramenta utilizada pelas maquinas na industrialização de uma matéria prima. Como um material pode ser estocado ?
