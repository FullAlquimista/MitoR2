/********************************************************************************
** Form generated from reading the UI file 'formcadastrarclassificacoesmateriais.ui'
**
...
#ifndef UI_FORMCADASTRARCLASSIFICACOESMATERIAIS_H
#define UI_FORMCADASTRARCLASSIFICACOESMATERIAIS_H
...
class Ui_FormCadastrarClassificacoesMateriais
{
public:
    ...
    void setupUi(QWidget *FormCadastrarClassificacoesMateriais)
    {
        if (FormCadastrarClassificacoesMateriais->objectName().isEmpty())
            FormCadastrarClassificacoesMateriais->setObjectName(QString::fromUtf8("FormCadastrarClassificacoesMateriais"));
        FormCadastrarClassificacoesMateriais->resize(867, 803);
        verticalLayout = new QVBoxLayout(FormCadastrarClassificacoesMateriais);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        scrollArea = new QScrollArea(FormCadastrarClassificacoesMateriais);
        scrollArea->setObjectName(QString::fromUtf8("scrollArea"));
        scrollArea->setProperty("widgetResizable", QVariant(true));
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QString::fromUtf8("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setProperty("geometry", QVariant(QRect(0, 0, 847, 783)));
...
"	background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0  rgb(138, 138, 138), stop:1 rgb(198, 185, 182));\n"
"	height: 25px;\n"
"   font-size: 14px;\n"
"}\n"
""
...
"QPushButton#pushButtonRemover\n"
"{\n"
"background-color:qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgb(255, 36, 16), stop:1 rgba(255, 255, 255, 255));\n"
"}\n"
"")));
        ...
        frameInformacoesGerais->setProperty("styleSheet", QVariant(QString::fromUtf8("QFrame#frameFormulario\n"
"{\n"
"	border: 1px solid #FF17365D;\n"
"	border-top-left-radius: 13px;\n"
"	border-top-right-radius: 13px;\n"
...
"}")));
        ...
        treeView = new QTreeView(subFrameInformaoesGerais);
        ...
        retranslateUi(FormCadastrarClassificacoesMateriais);

        QMetaObject::connectSlotsByName(FormCadastrarClassificacoesMateriais);
    }  // setupUi

    void retranslateUi(QWidget *FormCadastrarClassificacoesMateriais)
    {
        FormCadastrarClassificacoesMateriais->setProperty("windowTitle", QVariant(QApplication::translate("FormCadastrarClassificacoesMateriais", "FormCadastrarClassificacoesMateriais", nullptr)));
        labelTituloFormulario->setProperty("text", QVariant(QApplication::translate("FormCadastrarClassificacoesMateriais", "Formul\303\241rio para cadastrar uma nova classifica\303\247\303\243o de material", nullptr)));
        pushButtonAdicionar->setProperty("text", QVariant(QApplication::translate("FormCadastrarClassificacoesMateriais", "Adicionar", nullptr)));
        pushButtonSalvar->setProperty("text", QVariant(QApplication::translate("FormCadastrarClassificacoesMateriais", "Salvar altera\303\247\303\265es", nullptr)));
        pushButtonRemover->setProperty("text", QVariant(QApplication::translate("FormCadastrarClassificacoesMateriais", "Remover", nullptr)));
        pushButtonTituloInformacoesGerais->setProperty("text", QVariant(QApplication::translate("FormCadastrarClassificacoesMateriais", "Informa\303\247\303\265es gerais", nullptr)));
    }  // retranslateUi

};

namespace Ui {
    class FormCadastrarClassificacoesMateriais : public Ui_FormCadastrarClassificacoesMateriais {};
}  // namespace Ui

#endif // UI_FORMCADASTRARCLASSIFICACOESMATERIAIS_H
