/********************************************************************************
** Form generated from reading the UI file 'formcadastrartiposmateriais.ui'
**
...
#ifndef UI_FORMCADASTRARTIPOSMATERIAIS_H
#define UI_FORMCADASTRARTIPOSMATERIAIS_H
...
class Ui_FormCadastrarTiposMateriais
{
public:
    ...
    void setupUi(QWidget *FormCadastrarTiposMateriais)
    {
        if (FormCadastrarTiposMateriais->objectName().isEmpty())
            FormCadastrarTiposMateriais->setObjectName(QString::fromUtf8("FormCadastrarTiposMateriais"));
        FormCadastrarTiposMateriais->resize(754, 447);
        verticalLayout = new QVBoxLayout(FormCadastrarTiposMateriais);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        scrollArea = new QScrollArea(FormCadastrarTiposMateriais);
...
"}")));
        ...
        retranslateUi(FormCadastrarTiposMateriais);

        QMetaObject::connectSlotsByName(FormCadastrarTiposMateriais);
    }  // setupUi

    void retranslateUi(QWidget *FormCadastrarTiposMateriais)
    {
        FormCadastrarTiposMateriais->setProperty("windowTitle", QVariant(QApplication::translate("FormCadastrarTiposMateriais", "FormCadastrarTiposMateriais", nullptr)));
        labelTituloFormulario->setProperty("text", QVariant(QApplication::translate("FormCadastrarTiposMateriais", "Formul\303\241rio para cadastrar tipos de materiais no sistema", nullptr)));
        pushButtonAdicionar->setProperty("text", QVariant(QApplication::translate("FormCadastrarTiposMateriais", "Adicionar", nullptr)));
        pushButtonSalvar->setProperty("text", QVariant(QApplication::translate("FormCadastrarTiposMateriais", "Salvar altera\303\247\303\265es", nullptr)));
        pushButtonRemover->setProperty("text", QVariant(QApplication::translate("FormCadastrarTiposMateriais", "Remover", nullptr)));
        pushButtonTituloInformacoesGerais->setProperty("text", QVariant(QApplication::translate("FormCadastrarTiposMateriais", "Informa\303\247\303\265es gerais", nullptr)));
    }  // retranslateUi

};

namespace Ui {
    class FormCadastrarTiposMateriais : public Ui_FormCadastrarTiposMateriais {};
}  // namespace Ui

#endif // UI_FORMCADASTRARTIPOSMATERIAIS_H
